...
output = f"/home/kardosp/continuethelist/automatic_outputs/graphwalk_v4_output_sample{SAMPLE_SIZE}_seed{SEED}.pickle"


lc_quad_train = load_on_path(ds_lc_quad_train_cleaned)
# lc_quad_train = load_on_path(ds_lc_quad_unioned_cleaned)
